...
<!-- Nav -->
    ...
    <div class="row">
        <div id = "profileMenu" class=" border-right">
            ...
            <div class="mt-5 text-center"><a href = "/Buyer/viewSeller/<?=$data['profile']->profile_id?>" class="btn btn-primary profile-button" type="button"><i class='fas fa-comment'></i> Back</a>
            </div>
        </div>
