	    		...
	    		<div class="p-3 py-5">
					<form action='' method='post' enctype="multipart/form-data">
					    ...
					    <div class="form-group">
							Condition:&nbsp;&nbsp;
							<br>
							<label for="state_new">New <input type="radio" id="state_new" name="state" value="new"></label>
							<label for="state_used">Used <input type="radio" id="state_used" name="state" value="used"></label>
					  	</div>
							
						<div class="form-group">
							<label for="image_preview">Image:</label>
							<input type="file" name="image" id="image"/>
					    	<img id='image_preview' src='/images/blank.jpg' style="max-width:200px;max-height:200px"/>
					    </div>
				  			
				  		<button 
				  			type="submit" name="action" class="btn btn-success">Add your new Product
				  		</button>
