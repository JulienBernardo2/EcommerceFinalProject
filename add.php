    		...
    		<div class="p-3 py-5">
				<div class = "left">
					<form action='' method='post' enctype="multipart/form-data">
			    		...
			    		<div class="form-group">
				    		<label for="quantity">Category of Product: </label>
				    			<select name="category_id">
				    				<?php  
				    					foreach ($data['categorys'] as $category){
				    						echo "<option value='$category->category_id>$category->nicename</option>";
				    					}
				    				?>			    				
				    			</select>
				    	</div>
						...
						<div class="form-group">
			  			...
			  			<a  class="btn btn-primary" id="backBtn" href='/Product/indexSeller'>Back</a>
					</form>
				</div>
			</div>
		</div>
